Template.lineChart.onRendered(function() {
	...
	// 	var dataset = lifts.find().fetch();

	// 	// update scale domains and axises

	// 	// select elements that correspond to documents
	// 	//var bars = svg.selectAll("rect").data(dataset, key); // bind dataset to objects using key function

	// 	// handle new documents via enter()
	// 	//bars.enter()
	// 	//	.append("rect");

	// 	// handle updates to documents via transitions()
	// 	//bars.transition()
...
Template.lineChart.events({
	...
	// when select option is chosen
	// trigger showExerciseHistory to list all records for X amount of days/weeks
	// use graphing library to depict progress
